...
#ifndef GENERATOR_FILE
  int x_VAR_mcygwin;
#define x_VAR_mcygwin do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mthreads;
...
#define MASK_MS_BITFIELD_LAYOUT (1U << 11)
#define MASK_NOP_FUN_DLLIMPORT (1U << 12)
#define MASK_POKE_FUNCTION_NAME (1U << 13)
#define MASK_RETURN_AGGREGATES_IN_MEMORY (1U << 14)
#define MASK_SCHED_PROLOG (1U << 15)
#define MASK_SINGLE_PIC_BASE (1U << 16)
#define MASK_INTERWORK (1U << 17)
#define MASK_TPCS_FRAME (1U << 18)
#define MASK_TPCS_LEAF_FRAME (1U << 19)
#define MASK_NEON_VECTORIZE_DOUBLE (1U << 20)
...
#define TARGET_NOP_FUN_DLLIMPORT_P(target_flags) (((target_flags) & MASK_NOP_FUN_DLLIMPORT) != 0)
...
#define TARGET_RETURN_AGGREGATES_IN_MEMORY ((target_flags & MASK_RETURN_AGGREGATES_IN_MEMORY) != 0)
#define TARGET_RETURN_AGGREGATES_IN_MEMORY_P(target_flags) (((target_flags) & MASK_RETURN_AGGREGATES_IN_MEMORY) != 0)
...
enum opt_code
{
  ...
  OPT_fwritable_relocated_rdata = 1218,      /* -fwritable-relocated-rdata */
  ...
  /* OPT_mhard_float = 1299, */              /* -mhard-float */
  OPT_mlittle_endian = 1300,                 /* -mlittle-endian */
  OPT_mlong_calls = 1301,                    /* -mlong-calls */
  OPT_mms_bitfields = 1302,                  /* -mms-bitfields */
  OPT_mneon_for_64bits = 1303,               /* -mneon-for-64bits */
  OPT_mnop_fun_dllimport = 1304,             /* -mnop-fun-dllimport */
  ...
  OPT_mreturn_aggregates_in_memory = 1311,   /* -mreturn-aggregates-in-memory */
  ...
  OPT_mthreads = 1317,                       /* -mthreads */
  OPT_mthumb = 1318,                         /* -mthumb */
  OPT_mthumb_interwork = 1319,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1320,                  /* -mtls-dialect= */
  OPT_mtp_ = 1321,                           /* -mtp= */
  OPT_mtpcs_frame = 1322,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1323,               /* -mtpcs-leaf-frame */
  ...
  OPT_mwin32 = 1329,                         /* -mwin32 */
  OPT_mword_relocations = 1330,              /* -mword-relocations */
  OPT_n = 1331,                              /* -n */
  ...
  OPT_nolibc = 1337,                         /* -nolibc */
  OPT_nophoboslib = 1338,                    /* -nophoboslib */
  OPT_nostartfiles = 1339,                   /* -nostartfiles */
  OPT_nostdinc = 1340,                       /* -nostdinc */
  OPT_nostdinc__ = 1341,                     /* -nostdinc++ */
  OPT_nostdlib = 1342,                       /* -nostdlib */
  OPT_o = 1343,                              /* -o */
  OPT_p = 1344,                              /* -p */
  ...
  OPT_time = 1438,                           /* -time */
  OPT_time_ = 1439,                          /* -time= */
  OPT_traditional = 1440,                    /* -traditional */
  OPT_traditional_cpp = 1441,                /* -traditional-cpp */
  OPT_trigraphs = 1442,                      /* -trigraphs */
  OPT_u = 1443,                              /* -u */
  OPT_undef = 1444,                          /* -undef */
  OPT_v = 1445,                              /* -v */
  OPT_version = 1446,                        /* -version */
  OPT_w = 1447,                              /* -w */
  OPT_wrapper = 1448,                        /* -wrapper */
  OPT_x = 1449,                              /* -x */
  OPT_z = 1450,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
